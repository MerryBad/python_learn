...
def add_dummy_feature():
    a=[[1,3],[5,7]]
    print(a)
    b=preprocessing.add_dummy_feature(a) # feature = col
    print(b)
    print(type(b))
    print(b.dtype)
...
def binarizer():
    ...
    print(b)
    print(preprocessing.binarize(a, threshold=-2)) # threshold = 기준점
...
def label_binarizer():
    ...
    print(lb1.classes_) # 중복되지 않는 숫자들
